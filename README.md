...
| **Statistical rigor** | Logistic regression with marginal effects, VIF < 4, effect sizes (Cramér’s V up to 0.44, Cohen’s d = 0.24). Investigated negative coefficient for wifi – confirmed as suppression effect, true positive impact. |
